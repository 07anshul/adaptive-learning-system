...
SEED_PATH = Path("data/grade7_math_questions_seed_all.json")
...
def main() -> None:
    if not SEED_PATH.exists():
        raise SystemExit(f"Missing {SEED_PATH}. Run scripts/generate_questions_all.py first.")
    seed_questions()
    print(f"OK: seeded ALL questions from {SEED_PATH}")
